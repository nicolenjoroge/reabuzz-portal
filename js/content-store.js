...
(function (window) {
  ...
  function rollback(version) {
    if (!confirm('Restore ' + version + '?\n\nThe live site serves this version immediately and your draft is replaced.')) return;
          ...
          return '<div class="list-item" style="align-items:center;">' +
            '<div class="li-body">' +
              '<div class="li-title" style="display:flex;align-items:center;gap:8px;">' +
                v.version +
                (isLive ? '<span style="font-size:10px;background:#1a8a5a;color:#fff;padding:2px 7px;border-radius:4px;font-weight:bold;">LIVE</span>' : '') +
              '</div>' +
